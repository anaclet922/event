...
<form id="id-new-event-form" action="" method="post" enctype="multipart/form-data">
                        ...
                        Add new event
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              <label>Title:</label>
                              <input type="text" name="title" class="form-control" id="title" placeholder="Enter title" onkeyup="updateTopBar()" />
                            </div>


                            <div class="form-group">
                              <label>Description<span style="font-size: 12px;">(Optional)</span>:</label>
                              <textarea class="form-control textarea" name="description" placeholder="Enter event descrtiption"></textarea>
                            </div>
                              ...
                              <div class="bootstrap-timepicker">
                                <div class="form-group">
                                  ...
                                  <div class="input-group date" id="datepicker" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#datepicker" name="date" placeholder="Pick date" />
                              ...
                              <div class="bootstrap-timepicker">
                                <div class="form-group">
                                  ...
                                  <div class="input-group date" id="timepicker" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#timepicker" name="time" placeholder="Pick time" />
