...
?>
 <!-- Content Wrapper. Contains page content -->
      ...
      <div class="container-fluid">
         ...
         <div class="row">
            <div class="col-md-12">
              ...
              <form class="form" method="post" action="<?= base_url('news/post_update_news/' . $news[0]['id']) ?>" enctype="multipart/form-data">
                <div class="card card-danger" id="new-category-card">
                    ...
                    <div class="card-body">
                         ...
                         <div class="form-group">
                           <label>Title</label>
                           <input type="text" name="title" class="form-control" required value="<?= $news[0]['title'] ?>">
                         </div>

                         <div class="form-group">
                           <label>Content</label>
                           <textarea id="editor-main" class="form-control" name="body"><?= $news[0]['body'] ?></textarea>
                         </div>
  ...
  $(document).ready(function(){
       ...
       let preloaded= [
            {id: 1, src: '<?= base_url('uploads/news/' . $news[0]['thumbnail']) ?>'}
        ];
