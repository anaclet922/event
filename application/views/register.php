...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="<?= base_url() ?>post-register-user" method="post" id="register-form-id">
    ...
    $(document).ready(function(){
       ...
       $('#register-form-id').validate({
          ...
          messages: {
            ...
            password: {
              required: "Please choose password",
              minlength: "Password must be length of 8 to 20",
              maxlength: "Password must be length of 8 to 20"
            }
          },
          errorElement: 'span',
